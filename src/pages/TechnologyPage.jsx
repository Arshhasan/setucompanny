...
const techCategories = [
  ...
  },
  {
    ...
    href: '/gravity-filtration-process',
        ...
        <div className="container mx-auto px-4 max-w-7xl text-center">
          <AnimSection>
            ...
            <p className="text-[15px] text-body leading-[21px] max-w-3xl mx-auto">
              Through our vendor-neutral partner network, Setu Industrial Partners covers the entire oil processing value chain — from seed preparation through extraction, refining, oleochemicals, filtration, biodiesel and value-added products.
            </p>
          </AnimSection>
        </div>
      </section>
            ...
            {techCategories.map((cat, i) => (
              <AnimSection key={i} delay={i * 0.05}>
                <div className="bg-white shadow-sm hover:shadow-lg transition-all duration-300 group overflow-hidden">
                  <div className="p-6">
                    <div className="flex items-center gap-3 mb-4 border-l-4 border-accent pl-3">
